...
# Wyświetlenie 100 losowych obrazów z predykcjami przed i po ataku
...
for i in range(10):  # Zwiększenie liczby do 100 próbek
    ...
    print(f"Image {i+1}:")
    print(f"  - Przed atakiem: Predykcja: {init_pred}, Prawdziwa etykieta: {label.item()}")
    print(f"  - Po ataku: Predykcja: {final_pred}, Prawdziwa etykieta: {label.item()}")
    print("-" * 40)
